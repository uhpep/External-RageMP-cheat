...
int main()//int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
    ...
    {
        MessageBoxA(NULL, "Open the game first you fucking dumb nigger", "Error", MB_ICONERROR);
        return 0;
    }
...
void main_window()
{
	ImGui::Begin("MemoryHackers.org Made By uhpep");

	ImGui::Text("INS Show/Hide Menu, END To Quit Program");
	ImGui::Text("IF YOU PAID FOR THIS YOU GOT SCAMMED!");
